...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"OpenRivianEnabled", {PERSISTENT | BACKUP, BOOL}},
    {"OpenRivianApiDisabled", {PERSISTENT | BACKUP, BOOL}},
    {"OpenRivianBrokerDisabled", {PERSISTENT | BACKUP, BOOL}},
    {"OpenRivianTelemetryDisabled", {PERSISTENT | BACKUP, BOOL}},
    {"OpenRivianSettingsPublishDisabled", {PERSISTENT | BACKUP, BOOL}},
    {"OpenRivianWebDashboardDisabled", {PERSISTENT | BACKUP, BOOL}},
